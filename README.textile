...
sudo gem install kmt_oauth # (via gemcutter)

h2. Using the gem

To make authorized requests with the client library you'll need to "create a Twitter OAuth Application":http://weibopi.com/oauth_clients/new.
...
=> http://weibopi.com/oauth/authorize?oauth_token=TOKEN
</code></pre>
...
client.update('checking out the kmt_oauth library') # sends a twitter status update
</code></pre>
